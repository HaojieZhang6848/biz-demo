...
type Client interface {
	...
	Bye(ctx context.Context, Req *pbapi.Request, callOptions ...callopt.Option) (r *pbapi.Response, err error)
}
...
func (p *kEchoClient) Bye(ctx context.Context, Req *pbapi.Request, callOptions ...callopt.Option) (r *pbapi.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Bye(ctx, Req)
}
