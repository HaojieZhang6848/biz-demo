...
var file_echo_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x28, 0x0a, 0x03, 0x42, 0x79, 0x65, 0x12, 0x0e, 0x2e, 0x70, 0x62, 0x61, 0x70, 0x69,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x70, 0x62, 0x61, 0x70, 0x69,
...
var file_echo_proto_depIdxs = []int32{
	...
	0, // 1: pbapi.Echo.Bye:input_type -> pbapi.Request
	1, // 2: pbapi.Echo.Echo:output_type -> pbapi.Response
	1, // 3: pbapi.Echo.Bye:output_type -> pbapi.Response
...
type Echo interface {
	...
	Bye(ctx context.Context, req *Request) (res *Response, err error)
}
